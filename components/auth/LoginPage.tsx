          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-brand-300 text-brand-500 focus:ring-brand-500" />
                <span className="text-brand-600 dark:text-brand-400">Lembrar-me</span>
              </label>
